...
export const RetiradaLojasPage: React.FC = () => {
  ...
  // ── STEP: SCANNING ────────────────────────────────────────────────────────────
  return (
    <Content style={{ padding: "16px 0px", maxWidth: "100%" }}>
      <Space direction="vertical" size="middle" style={{ width: "100%" }}>
        ...
        <Card
          title={
            <Space>
              <Text strong>Produtos Bipados</Text>
              {items.length > 0 && (
                <Tag color={BStoriesThemeTokens.primary}>{items.length}</Tag>
              )}
            </Space>
          }
          extra={
          ...
          <>
            ...
            <div style={{ display: "flex", justifyContent: "flex-end" }}>
              ...
              >
                ...
                >
                  Confirmar Retirada ({items.length}{" "}
